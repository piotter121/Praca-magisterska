...
Po wyznaczeniu porównywanych metryk i scenariuszy testowych przystąpiono do testów.
...
\textbf{Słowa kluczowe:} bazy nierelacyjne, hybrydowy model danych, NoSQL 
...
\textbf{Keywords:} non-relational bases, hybrid data model, NoSQL
